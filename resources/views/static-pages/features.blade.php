	...
	<section class="featuresSingles">
		<div class="wrapper">
			...
			<article class="never-miss-a-call">
				...
				<p>Unlike other providers that make you sign long-term contracts to get the best deals on their services, we don't require anything more than a month contract with us. Get the plan that's right for you and cancel any time you want without any penalties or cancellation fees!.</p>
			</article>
			<article class="hotspots">
				<h3>We have you covered</h3>
				<p>Connected Internet offers 24/7 support, so whether you're having connection problems or just need some help setting up your new router, we're here to help.
  </p>
			</article>
