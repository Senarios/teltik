...
<div class='btn-wrap title-medium'>
                            <a class="btn style3 run-ajax add-without-device" href="{{url('/plans')}}" style="
    font-size: 16px;
    font-weight: 300;
">Get Started</a>
                        </div>   
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-lg-7 col-md-7 d-flex flex-column justify-content-center align-items-stretch">
                        <div class="content">
                            <h2 class="l-title title-medium">In Home or on the GO - we got you!</h2>
                            <p class="text">
In this day and age, nearly everyone needs to access the internet with a reliable connection. We offer internet service to our customers that is second to none through the use of 4G cellular towers. Providing you with a truly limitless internet connection, our internet service is dependable and ultra-fast with no data caps! To sweeten the deal even more, we offer hassle-free pricing and 24/7 service.
                            </p>
        ...
        <section id="features" class="why-us feat"
            ...
            <div class="container">
                ...
                <div class="section-title">
                    <h2>Features</h2>
                    <p class="steps">We belive in keeping things simple. So all plans come</br>with these great
                        features</p>
                </div>
                ...
                <div class="row desctop_feature_slider">
                    ...
                    <div class="col-lg-6">
                        <div class="box">
                            ...
                            <h4>4G Network</br>Nationwide Access</h4>
                ...
                <div class="row reviews destop_review_slider">
                    ...
                    <div class="col-lg-4 mt-4 mt-lg-0">
                        ...
                        <div class="box grey m-top">
                            ...
                            <p>Switching to has allowed me cut my cost for wireless service by about two thirds, and
